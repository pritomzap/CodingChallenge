package com.platinacode.challenge.core.network

import android.os.Build
import android.util.Log
import com.deshipay.common.network.Tls12SocketFactory
import com.google.gson.GsonBuilder
import com.platinacode.challenge.BuildConfig
import okhttp3.*
        ...
        if (retrofit == null) {
            ...
            client.addNetworkInterceptor { chain ->
                    val request = chain.request().newBuilder()
                            ...
                            //.addHeader("Accept-Language", preferenceHelper.getLanguagePref())
